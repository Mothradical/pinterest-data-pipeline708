...
invoke_url_pin = "https://jnh2wjrl1j.execute-api.us-east-1.amazonaws.com/test/topics/1254dc635ec5.pin"
invoke_url_geo = "https://jnh2wjrl1j.execute-api.us-east-1.amazonaws.com/test/topics/1254dc635ec5.geo"
invoke_url_user = "https://jnh2wjrl1j.execute-api.us-east-1.amazonaws.com/test/topics/1254dc635ec5.user"
...
class AWSDBConnector:
    ...
    def create_db_connector(self, cred_dict: dict):
        # Adding extra parameter for code reusability
...
credentials = new_connector.read_db_creds(local_path)
    ...
    while True:
        ...
        with engine.connect() as connection:
            ...
            pin_response = requests.request(
                "POST", invoke_url_pin, headers=headers, data=pin_payload
            )
            geo_response = requests.request(
                "POST", invoke_url_geo, headers=headers, data=geo_payload
            )
            user_response = requests.request(
                "POST", invoke_url_user, headers=headers, data=user_payload
            )
